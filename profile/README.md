...
| L1 | [trifuse](https://github.com/open-infra-ai/trifuse) | 精简 Triton 算子（RMSNorm+RoPE / GatedMLP / FA 前向 / SGEMM）+ torch.library 注册 | stable |
...
阅读顺序：`cuda-foundations → trifuse → cuflash → tiny-llm → paged-serving`。
